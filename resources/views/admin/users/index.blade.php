...
<div class="list-grid-nav hstack gap-1 mb-3">
    ...
    <a href="{{ route('getAddAdminUser') }}?return_url={{ route('getAdminUsers') }}" id="btn_add_new_data" class="btn btn-primary" title="Add Data">
...
<div class="card">
    <div class="card-header align-items-center d-flex">
        ...
        <div class="box-tools pull-right" style="position: relative;margin-top: -5px;margin-right: -10px">
            ...
            <form method="get" style="display:inline-block;width: 290px;" action="{{ route('users.index') }}">
                <div class="input-group">
                    <input type="text" name="q" value="{{ request()->get('q') }}" class="form-control rounded-0 pull-right" placeholder="Search">

                    <div class="input-group-btn">
                        @if(!empty(request()->get('q')))
                        <button type="button" onclick="location.href='{{ route('users.index') }}'" title="Reset" class="btn rounded-0 btn-warning"><i class="fa fa-ban"></i></button>
                        @endif
            ...
            <form method="get" id="form-limit-paging" style="display:inline-block" action="{{ route('users.index') }}">
                @php $limits =[5,10,20,25,50,100,200]; @endphp
                <div class="input-group">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <form id="form-table" method="post" action="{{ route('users.index') }}/action-selected">
