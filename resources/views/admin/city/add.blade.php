...
<p><a title="Main Module" href="{{ AdminHelper::adminpath() }}/cities"><i class="fa fa-chevron-circle-left "></i> &nbsp; Back To List Data Manage City</a></p>
        ...
        <div class="card">
            ...
            <form action="{{ route('postAddCity') }}" method="post" enctype="multipart/form-data"> 
                ...
                <div class="row">
                     ...
                     <div class="col-md-6">
                        <div class="mb-3 ">
                            <label for="Nameinput" class="form-label">States<span class="text-danger" title="This field is required">*</span></label>
                            <select class="form-control" name="state_id" id="state_id" required>
                            <option value="">Select State</option>
                             @foreach($states as $key=> $states_data)    
