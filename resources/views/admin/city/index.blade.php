...
<div class="list-grid-nav hstack gap-1 mb-3">
    ...
    <a href="{{ AdminHelper::adminpath()}}/cities/add?return_url={{ AdminHelper::adminpath()}}/cities"
...
<div class="card">
    <div class="card-header align-items-center d-flex">
        ...
        <div class="box-tools pull-right" style="position: relative;margin-top: -5px;margin-right: -10px">   
            ...
            <form method="get" style="display:inline-block;width: 290px;"
                action="{{ AdminHelper::adminpath()}}/cities">
                <div class="input-group">
                    <input type="text" name="q" value="{{ request()->get('q') }}" class="form-control rounded-0 pull-right" placeholder="Search">

                    <div class="input-group-btn">
                        @if(!empty(request()->get('q')))
                        <button type="button" onclick="location.href='{{ AdminHelper::adminpath() }}/cities'" title="Reset" class="btn rounded-0 btn-warning"><i class="fa fa-ban"></i></button>
                        @endif
    ...
    <div class="card-body">
        <div class="table-responsive">
            <form id="form-table" method="post" action="{{ AdminHelper::adminpath()}}/cities/action-selected">
                ...
                <table id="table_dashboard" class="table align-middle table-nowrap table-hover mb-0">
                    <thead class="table-blue">
                        <tr class="active">
                            ...
                            <th width="auto"><a href="{{ AdminHelper::adminpath()}}/cities?filter_column=name&sorting={{(request()->get('filter_column')=='name' && request()->get('sorting')=='asc')?'desc':'asc'}}" title="Click to sort ascending">Name &nbsp; <i class="fa fa-sort"></i></a></th>
                             <th width="auto">State Name</th>    
                             <th width="auto">Country Name</th>  
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->getState->getCountry->name }}</td>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-primary btn-detail" title="Detail Data" href="{{ AdminHelper::adminpath()}}/cities/detail/{{$data->id}}?return_url={{ AdminHelper::adminpath()}}/cities"><i class="fa fa-eye"></i></a>
                                @endif
                                @if(AdminHelper::isUpdate())
                                <a class="btn btn-sm btn-success btn-edit" title="Edit Data" href="{{ AdminHelper::adminpath()}}/cities/edit/{{$data->id}}?return_url={{ AdminHelper::adminpath()}}/cities"><i class="fa fa-pencil"></i></a>
                                @endif
                                ...
                                <a class="btn btn-sm btn-warning btn-delete" title="Delete" href="javascript:;" onclick="Swal.fire({
                                    ...
                                    t.isConfirmed?location.href='{{ AdminHelper::adminpath() }}/cities/delete/{{$data->id}}':'' });">
                        ...
                        @else
                        <tr>
                            <td colspan="6" style="text-align:center"><i class="fa fa-search"></i> No Data Avaliable</td>
                        </tr>
                        @endif                        
                    </tbody>
                </table>
