            	...
            	<div class="row">
            		<div class="col-md-6">
            			<div class="mb-3 ">
					        ...
					        <input type="text" title="Page Title" class="form-control" name="page_title" value="{{ old('page_title') }}" placeholder="Name" required>					        
					        @error('page_title')
            		...
            		<div class="col-md-6">
            			<div class="mb-3 ">
					        ...
					        <input type="text" title="Meta Title" class="form-control" name="meta_title" value="{{ old('meta_title') }}" placeholder="Meta Title" required>					        
					        @error('meta_title')
		                        <div class="text-danger mt-1" role="alert">
		                            <strong>{{ $message }}</strong>
		                        </div>
            		...
            		<div class="col-md-6">
            			<div class="mb-3 ">
					        ...
					        <input type="text" title="Meta Keywords" class="form-control" name="meta_keywords" value="{{ old('meta_keywords') }}">						        
					        @error('meta_keywords')
		                        <div class="text-danger mt-1" role="alert">
		                            <strong>{{ $message }}</strong>
		                        </div>
