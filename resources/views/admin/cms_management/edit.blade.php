            	...
            	<div class="row">
            		<div class="col-md-6">
            			<div class="mb-3 ">
					        ...
					        <input type="text" title="Page Title" class="form-control" name="page_title" value="{{ (old('page_title'))?old('page_title'):$row->page_title }}" placeholder="Name" required readonly>					        
					        @error('page_title')
            		...
            		<div class="col-md-12">
            			<div class="mb-3 ">
					        ...
					        <textarea name="content" class="form-control" id="description">{!! (old('content'))?old('content'):$row->page_content !!}</textarea>				        
					        @error('content')
		                        <div class="text-danger mt-1" role="alert">
		                            <strong>{{ $message }}</strong>
		                        </div>
