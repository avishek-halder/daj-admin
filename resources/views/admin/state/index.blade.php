...
<div class="list-grid-nav hstack gap-1 mb-3">
    ...
    <a href="{{ AdminHelper::adminpath()}}/states/add?return_url={{ AdminHelper::adminpath()}}/states"
...
<div class="card">
    <div class="card-header align-items-center d-flex">
        ...
        <div class="box-tools pull-right" style="position: relative;margin-top: -5px;margin-right: -10px">   
            ...
            <form method="get" style="display:inline-block;width: 290px;"
                action="{{ AdminHelper::adminpath()}}/states">
                <div class="input-group">
                    <input type="text" name="q" value="{{ request()->get('q') }}" class="form-control rounded-0 pull-right" placeholder="Search">

                    <div class="input-group-btn">
                        @if(!empty(request()->get('q')))
                        <button type="button" onclick="location.href='{{ AdminHelper::adminpath() }}/states'" title="Reset" class="btn rounded-0 btn-warning"><i class="fa fa-ban"></i></button>
                        @endif
    ...
    <div class="card-body">
        <div class="table-responsive">
            <form id="form-table" method="post" action="{{ AdminHelper::adminpath()}}/states/action-selected">
                ...
                <table id="table_dashboard" class="table align-middle table-nowrap table-hover mb-0">
                    <thead class="table-blue">
                        <tr class="active">
                            ...
                            <th width="auto"><a href="{{ AdminHelper::adminpath()}}/states?filter_column=name&sorting={{(request()->get('filter_column')=='name' && request()->get('sorting')=='asc')?'desc':'asc'}}" title="Click to sort ascending">Name &nbsp; <i class="fa fa-sort"></i></a></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-primary btn-detail" title="Detail Data" href="{{ AdminHelper::adminpath()}}/states/detail/{{$data->id}}?return_url={{ AdminHelper::adminpath()}}/states"><i class="fa fa-eye"></i></a>
                                @endif
                                @if(AdminHelper::isUpdate())
                                <a class="btn btn-sm btn-success btn-edit" title="Edit Data" href="{{ AdminHelper::adminpath()}}/states/edit/{{$data->id}}?return_url={{ AdminHelper::adminpath()}}/states"><i class="fa fa-pencil"></i></a>
                                @endif
                                ...
                                <a class="btn btn-sm btn-warning btn-delete" title="Delete" href="javascript:;" onclick="Swal.fire({
                                    ...
                                    t.isConfirmed?location.href='{{ AdminHelper::adminpath() }}/states/delete/{{$data->id}}':'' });">
