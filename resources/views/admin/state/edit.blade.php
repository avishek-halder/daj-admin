...
<div class="row">
	<div class="col-md-12">
		<div class="card">
            ...
            <div class="card-body">
            	<form action="{{ route('postUpdateState', $row->id) }}" method="post" enctype="multipart/form-data">
            	@csrf
            	<input type="hidden" name="return_url" value="{{ AdminHelper::adminpath() }}/states">
            	<div class="row">
                        ...
                        <div class="mb-3 ">
                            ...
                            <option value="">Select Country</option>
                             @foreach($country as $key=> $country_data)    
                                <option value="{{$country_data->id}}"  @if($row->country_id==$country_data->id) selected @endif>{{$country_data->name}} </option>
                            @endforeach
            	...
            	<div class="row g-3">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                            	<a href="{{ AdminHelper::adminpath() }}/states" class="btn btn-default"><i class="fa fa-chevron-circle-left"></i> Back</a>                            	
