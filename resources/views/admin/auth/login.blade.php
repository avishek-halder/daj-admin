...
<head>
    ...
    <link rel="icon" type="image/ico" sizes="32x32" href="{{ asset('assets/admin/favicon/favicon.ico') }}">
    <!-- App favicon -->
                                    ...
                                    <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                ...
                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted mt-3" type="button"><i class="ri-eye-fill align-middle" id="password-addon"></i></button>
                                            </div>
                                        </div>
