<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        <!-- Dark Logo-->
        <a href="{{AdminHelper::adminPath('dashboard')}}" class="logo logo-dark">
            @if(!empty(AdminHelper::getSetting('logo')))
            <span class="logo-sm">
                <img src="{{asset('assets/admin/images/logo-icon.png')}}" alt="" height="20">
            </span>
            <span class="logo-lg">
                <img src="{{asset('assets/admin/images/logo-p.png')}}" alt="" height="40">
            </span>
            @else
