                ...
                <form method="post" id="form" enctype="multipart/form-data" action="{{ route('postSaveGeneralSettings') }}">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <a class="btn btn-danger btn-delete btn-sm" onclick="if(!confirm('Are you sure ?')) return false" href="{{AdminHelper::adminpath()}}/delete-image?image={{$row->logo}}&&id={{$row->id}}&&column=logo&table=admin_settings"><i class="fa fa-ban"></i> Delete </a></p>
                            @else
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="prev-img-thumb" style="width:60px;"><img src="{{ asset($row->favicon) }}"></div>
                            <p class="text-muted"><em>* If you want to upload other image, please first delete the image.</em></p>
                            ...
                            <a class="btn btn-danger btn-delete btn-sm" onclick="if(!confirm('Are you sure ?')) return false" href="{{AdminHelper::adminpath()}}/delete-image?image={{$row->favicon}}&&id={{$row->id}}&&column=favicon&table=admin_settings"><i class="fa fa-ban"></i> Delete </a></p>
                            @else
                        ...
                        <div class="form-group mb-3">
                            <label class="label-setting">Contact Email</label>
                            <input type="email" class="form-control" name="contact_email" value="{{ (old('contact_email')?old('contact_email'):(!empty($row)?$row->contact_email:'')) }}">
                            <div class="text-muted"></div>
                            @error('contact_email')
                                <div class="text-danger mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
