...
<div class="list-grid-nav hstack gap-1 mb-3">
    ...
    <a href="{{ route('getAddClient') }}?return_url={{ route('getManageClients') }}"
...
<div class="card">
    <div class="card-header align-items-center d-flex">
        ...
        <div class="box-tools pull-right" style="position: relative;margin-top: -5px;margin-right: -10px">   
            ...
            <form method="get" style="display:inline-block;width: 290px;"
                action="{{ route('getManageClients') }}">
                <div class="input-group">
                    <input type="text" name="q" value="{{ request()->get('q') }}" class="form-control rounded-0 pull-right" placeholder="Search">

                    <div class="input-group-btn">
                        @if(!empty(request()->get('q')))
                        <button type="button" onclick="location.href='{{ route('getManageClients') }}'" title="Reset" class="btn rounded-0 btn-warning"><i class="fa fa-ban"></i></button>
                        @endif
    ...
    <div class="card-body">
        <div class="table-responsive">
            <form id="form-table" method="post" action="{{ route('getManageClients') }}/action-selected">
                ...
                <table id="table_dashboard" class="table align-middle table-nowrap table-hover mb-0">
                    <thead class="table-blue">
                        <tr class="active">
                            ...
                            <th><a href="{{ route('getManageClients') }}?filter_column=uname&sorting={{(request()->get('filter_column')=='uname' && request()->get('sorting')=='asc')?'desc':'asc'}}" title="Click to sort ascending">Username &nbsp; <i class="fa fa-sort"></i></a></th>
                            <th><a href="{{ route('getManageClients') }}?filter_column=fname&sorting={{(request()->get('filter_column')=='fname' && request()->get('sorting')=='asc')?'desc':'asc'}}" title="Click to sort ascending">First Name &nbsp; <i class="fa fa-sort"></i></a></th>
                            <th><a href="{{ route('getManageClients') }}?filter_column=lname&sorting={{(request()->get('filter_column')=='lname' && request()->get('sorting')=='asc')?'desc':'asc'}}" title="Click to sort ascending">Last Name &nbsp; <i class="fa fa-sort"></i></a></th>
                            <th><a href="{{ route('getManageClients') }}?filter_column=email&sorting={{(request()->get('filter_column')=='email' && request()->get('sorting')=='asc')?'desc':'asc'}}" title="Click to sort ascending">Email &nbsp; <i class="fa fa-sort"></i></a></th>
                            <th><a href="{{ route('getManageClients') }}?filter_column=phone_number&sorting={{(request()->get('filter_column')=='phone_number' && request()->get('sorting')=='asc')?'desc':'asc'}}" title="Click to sort ascending">Phone Number &nbsp; <i class="fa fa-sort"></i></a></th>
                            <th><a href="{{ route('getManageClients') }}?filter_column=status&sorting={{(request()->get('filter_column')=='status' && request()->get('sorting')=='asc')?'desc':'asc'}}" title="Click to sort ascending">Status &nbsp; <i class="fa fa-sort"></i></a></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-success btn-edit" title="Edit Data" href="{{ route('getEditClient', $data->id) }}?return_url={{ route('getManageClients') }}"><i class="fa fa-pencil"></i></a>
                                ...
                                <a class="btn btn-sm btn-warning btn-delete" title="Delete" href="javascript:;" onclick="Swal.fire({
                                    ...
                                    t.isConfirmed?location.href='{{ route("deleteClient", $data->id) }}':'' });">
