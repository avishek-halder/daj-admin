                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                    ...
                                    <form autocomplete='off' action="<?php echo e(route('postLogin')); ?>" method="post">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                ...
                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted" type="button" ><i class="ri-eye-fill align-middle" id="password-addon"></i></button>
                                            </div>
                                        </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0 forgottext">Forgot your password? <a href='<?php echo e(route("getForgot")); ?>' class="fw-semibold text-primary text-decoration-underline"> Click here </a> </p>
                        </div>
...
</html><?php /**PATH F:\laravel\daj-home\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>