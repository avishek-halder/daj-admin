...
<div class="list-grid-nav hstack gap-1 mb-3">
    ...
    <?php if(AdminHelper::isCreate()): ?>
     <a href="<?php echo e(route('getAddCms')); ?>?return_url=<?php echo e(route('getManageCMS')); ?>"
...
<div class="card">
    <div class="card-header align-items-center d-flex">
        ...
        <div class="box-tools pull-right" style="position: relative;margin-top: -5px;margin-right: -10px">   
            ...
            <form method="get" style="display:inline-block;width: 290px;"
                action="<?php echo e(route('getManageCMS')); ?>">
                <div class="input-group">
                    ...
                    <div class="input-group-btn">
                        ...
                        <button type="button" onclick="location.href='<?php echo e(route('getManageCMS')); ?>'" title="Reset" class="btn rounded-0 btn-warning"><i class="fa fa-ban"></i></button>
                        <?php endif; ?>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <form id="form-table" method="post" action="<?php echo e(route('getManageCMS')); ?>/action-selected">
                ...
                <table id="table_dashboard" class="table align-middle table-nowrap table-hover mb-0">
                    <thead class="table-blue">
                        <tr class="active">
                            ...
                            <th width="auto"><a href="<?php echo e(route('getManageCMS')); ?>?filter_column=page_title&sorting=<?php echo e((request()->get('filter_column')=='page_title' && request()->get('sorting')=='asc')?'desc':'asc'); ?>" title="Click to sort ascending">Page &nbsp; <i class="fa fa-sort"></i></a></th>
                            <th width="auto"><a href="<?php echo e(route('getManageCMS')); ?>?filter_column=meta_title&sorting=<?php echo e((request()->get('filter_column')=='meta_title' && request()->get('sorting')=='asc')?'desc':'asc'); ?>" title="Click to sort ascending">Meta Title &nbsp; <i class="fa fa-sort"></i></a></th>
                            <!-- <th width="auto"><a href="<?php echo e(route('getManageCMS')); ?>?filter_column=status&sorting=<?php echo e((request()->get('filter_column')=='status' && request()->get('sorting')=='asc')?'desc':'asc'); ?>" title="Click to sort ascending">Status &nbsp; <i class="fa fa-sort"></i></a></th>    -->                         
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($data->page_title); ?></td>
                            <td><?php echo e($data->meta_title); ?></td>
                           <!--  <td><?php if($data->status==1): ?> <span class="badge bg-success">Active</span> <?php else: ?> <span class="badge bg-danger">Inactive</span> <?php endif; ?></td> -->
                            <td>
                                <div class="button_action" style="text-align:right">
                                    <?php if(AdminHelper::isView()): ?>
                                    <a class="btn btn-sm btn-primary btn-detail" title="Detail Data" href="<?php echo e(route('getManageCMS')); ?>/detail/<?php echo e($data->id); ?>?return_url=<?php echo e(route('getManageCMS')); ?>"><i class="fa fa-eye"></i></a>
                                    <?php endif; ?>
                                    <?php if(AdminHelper::isUpdate()): ?>
                                    <a class="btn btn-sm btn-success btn-edit" title="Edit Data" href="<?php echo e(route('getManageCMS')); ?>/edit/<?php echo e($data->id); ?>?return_url=<?php echo e(route('getManageCMS')); ?>"><i class="fa fa-pencil"></i></a>
                                    <?php endif; ?>
                                    <?php if(AdminHelper::isDelete()): ?>
                                <!-- <a class="btn btn-sm btn-warning btn-delete" title="Delete" href="javascript:;" onclick="Swal.fire({
				                    ...
				                    t.isConfirmed?location.href='<?php echo e(AdminHelper::adminpath()); ?>/manage-cms/delete/<?php echo e($data->id); ?>':'' });">
...
<?php echo $__env->make('admin::layouts.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel\daj-home\resources\views/admin/cms_management/index.blade.php ENDPATH**/ ?>