...
<div class="list-grid-nav hstack gap-1 mb-3">
  <!--   <div class="selected-action" style="display:inline-block;position:relative;">
    ...
    <a href="<?php echo e(route('getAddAdminUser')); ?>?return_url=<?php echo e(route('getAdminUsers')); ?>"
...
<div class="card">
    <div class="card-header align-items-center d-flex">
        ...
        <div class="box-tools pull-right" style="position: relative;margin-top: -5px;margin-right: -10px">   
            ...
            <form method="get" style="display:inline-block;width: 290px;"
                action="<?php echo e(route('getAdminUsers')); ?>">
                <div class="input-group">
                    ...
                    <div class="input-group-btn">
                        ...
                        <button type="button" onclick="location.href='<?php echo e(route('getAdminUsers')); ?>'" title="Reset" class="btn rounded-0 btn-warning"><i class="fa fa-ban"></i></button>
                        <?php endif; ?>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <form id="form-table" method="post" action="<?php echo e(route('getAdminUsers')); ?>/action-selected">
                ...
                <table id="table_dashboard" class="table align-middle table-nowrap table-hover mb-0">
                    <thead class="table-blue">
                        <tr class="active">
                            ...
                            <th><a href="<?php echo e(route('getAdminUsers')); ?>?filter_column=name&sorting=<?php echo e((request()->get('filter_column')=='name' && request()->get('sorting')=='asc')?'desc':'asc'); ?>" title="Click to sort ascending">Name &nbsp; <i class="fa fa-sort"></i></a></th>
                            <th><a href="<?php echo e(route('getAdminUsers')); ?>?filter_column=email&sorting=<?php echo e((request()->get('filter_column')=='email' && request()->get('sorting')=='asc')?'desc':'asc'); ?>" title="Click to sort ascending">Email &nbsp; <i class="fa fa-sort"></i></a></th>
                            <th><a href="<?php echo e(route('getAdminUsers')); ?>?filter_column=id_admin_privileges&sorting=<?php echo e((request()->get('filter_column')=='id_admin_privileges' && request()->get('sorting')=='asc')?'desc':'asc'); ?>" title="Click to sort ascending">Privilege &nbsp; <i class="fa fa-sort"></i></a></th>
                            <th><a href="<?php echo e(route('getAdminUsers')); ?>?filter_column=status&sorting=<?php echo e((request()->get('filter_column')=='status' && request()->get('sorting')=='asc')?'desc':'asc'); ?>" title="Click to sort ascending">Status &nbsp; <i class="fa fa-sort"></i></a></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e((!empty($data->privilege)?$data->privilege->name:'')); ?></td>         
...
<?php echo $__env->make('admin::layouts.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel\daj-home\resources\views/admin/admin_users/index.blade.php ENDPATH**/ ?>